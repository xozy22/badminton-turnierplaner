...
> („zurueck" → „zurück"), und eine sachlich falsche Aussage ist unten als
...
## Match per Rechtsklick zurück in die Warteschlange (v2.9.0)
...
## Sportstätte als first-class Bestandteil von Export & Import (v2.8.8)
...
## Vorlagen-Import & Sportstätten (v2.8.7)
...
## Session-Pill in Turnierübersicht (v2.8.5)
...
## Sportstätte-Löschen-Guard (v2.8.4)
