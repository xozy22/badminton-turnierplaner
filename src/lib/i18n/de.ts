...
export const de: Translations = {
  ...
  players_archive_hint: "Spieler mit Spielhistorie werden archiviert statt geloescht - ihre Ergebnisse bleiben erhalten.",
  players_delete_done: "{count} Spieler geloescht.",
  players_delete_blocked: "Nicht geloescht - diese Spieler haben bereits gespielt: {players}",
  ...
  tournament_venue_required: "Sportstaette ist erforderlich",
  tournament_venue_pick_placeholder: "-- Sportstaette auswaehlen --",
  tournament_venue_no_venues_title: "Keine Sportstaette angelegt",
  tournament_venue_no_venues_message: "Bevor du ein Turnier erstellen kannst, musst du mindestens eine Sportstaette mit Hallen und Feldern definieren.",
  ...
  validation_min_players: "Mindestens {count} Spieler noetig",
  ...
  validation_groups_min: "Mindestens zwei Gruppen noetig",
  validation_groups_too_many: "{groups} Gruppen bei {participants} Teilnehmern - jede Gruppe braucht mindestens zwei",
  validation_ko_size_too_large: "KO-Groesse {koSize} ist groesser als die Teilnehmerzahl ({participants})",
  validation_rounds_min: "Mindestens eine Runde noetig",
  validation_rounds_exceed_opponents: "{rounds} Runden bei nur {maxRounds} moeglichen Gegnern - Wiederholungen sind unvermeidbar",
  validation_waterfall_sit_out: "{sittingOut} Teilnehmer setzen pro Runde aus ({courts} Felder verfuegbar)",
  validation_kotc_single_court: "King of the Court nutzt nur ein Feld - die uebrigen bleiben frei",
  ...
  settings_db_reset_message: "Speicherort wird auf Standard zurueckgesetzt - App startet neu...",
  ...
  sessions_subtitle: "Mehrere Turniere parallel an derselben Sportstaette",
  ...
  sessions_end_confirm: "Session jetzt beenden? Turniere bleiben angedockt und koennen einzeln weiterlaufen.",
  ...
  session_attach_blocked_status_hint: "Turniere koennen nur an aktive Sessions angedockt werden. Reaktiviere die Session zuerst.",
  sessions_reactivate: "Reaktivieren",
  sessions_archive: "Archivieren",
  sessions_unarchive: "Archivierung aufheben",
  sessions_delete: "Loeschen",
  sessions_delete_confirm_title: "Session loeschen?",
  ...
  session_venue_label: "Sportstaette",
  session_venue_none: "Keine (Session ohne festen Ort)",
  session_attach_active_tournaments: "Aktive Turniere direkt anhaengen",
  ...
  session_detail_attach_button: "Turnier hinzufuegen",
  session_detail_attach_dialog_title: "Turnier zur Session hinzufuegen",
  session_detail_attach_dialog_hint: "Nur Turniere am gleichen Venue (oder ohne Venue), die noch keiner Session angehoeren.",
  session_detail_attach_no_candidates: "Keine passenden Turniere verfuegbar.",
  session_detail_detach: "Aus Session loesen",
  session_detail_detach_confirm: "Turnier von dieser Session loesen? Es laeuft danach eigenstaendig weiter.",
  session_detail_open_tournament: "Oeffnen",
  ...
  session_dashboard_subtitle: "Live-Uebersicht ueber alle Turniere dieser Session",
  ...
  session_dashboard_no_courts: "Keine Felder definiert (Sportstaette setzen).",
  ...
  session_pill_open_dashboard: "Dashboard oeffnen",
  ...
  sportstaetten_active_sessions: "Aktive Sessions an dieser Sportstaette",
