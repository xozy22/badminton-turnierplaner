// src/lib/releaseNotes.generated.ts
//
// GENERATED by scripts/build-release-notes.mjs -- do not edit.
// The source is CHANGELOG.md and CHANGELOG.en.md; run `pnpm build:notes` after
...
export interface ReleaseNote {
  ...
  de: string;
  /**
   * English notes, markdown. Null for versions before 2.10.0,
